        ...
        children: [
            {
                ...
                description: 'Request a specific permission string with Puter.js permissions API. Run and experiment with this example in the playground.',
                slug: 'perms-request-permission',
                source: '/playground/examples/perms-request-permission.html'
            },
            {
                title: 'Request Email Access',
                description: 'Request access to user email with Puter.js permissions API. Run and modify this code example instantly in your browser.',
                slug: 'perms-request-email',
                source: '/playground/examples/perms-request-email.html'
            },
            {
                title: 'Request Desktop Read Access',
                description: 'Request read access to Desktop folder with Puter.js permissions API. Run and experiment with this example directly in the playground.',
                slug: 'perms-request-read-desktop',
                source: '/playground/examples/perms-request-read-desktop.html'
            },
            {
                title: 'Request Desktop Write Access',
                description: 'Request write access to Desktop folder with Puter.js permissions API. Run and modify this code example instantly in your browser.',
                slug: 'perms-request-write-desktop',
                source: '/playground/examples/perms-request-write-desktop.html'
            },
            {
                title: 'Request Documents Read Access',
                description: 'Request read access to Documents folder with Puter.js permissions API. Run and experiment with this example in the playground.',
                slug: 'perms-request-read-documents',
                source: '/playground/examples/perms-request-read-documents.html'
            },
            {
                title: 'Request Documents Write Access',
                description: 'Request write access to Documents folder with Puter.js permissions API. Run and modify this code example instantly in your browser.',
                slug: 'perms-request-write-documents',
                source: '/playground/examples/perms-request-write-documents.html'
            },
            {
                title: 'Request Pictures Read Access',
                description: 'Request read access to Pictures folder with Puter.js permissions API. Run and experiment with this example directly in the playground.',
                slug: 'perms-request-read-pictures',
                source: '/playground/examples/perms-request-read-pictures.html'
            },
            {
                title: 'Request Pictures Write Access',
                description: 'Request write access to Pictures folder with Puter.js permissions API. Run and modify this code example instantly in your browser.',
                slug: 'perms-request-write-pictures',
                source: '/playground/examples/perms-request-write-pictures.html'
            },
            {
                title: 'Request Videos Read Access',
                description: 'Request read access to Videos folder with Puter.js permissions API. Run and experiment with this example in the playground.',
                slug: 'perms-request-read-videos',
                source: '/playground/examples/perms-request-read-videos.html'
            },
            {
                title: 'Request Videos Write Access',
                description: 'Request write access to Videos folder with Puter.js permissions API. Run and modify this code example instantly in your browser.',
                slug: 'perms-request-write-videos',
                source: '/playground/examples/perms-request-write-videos.html'
            },
            {
                title: 'Request Apps Read Access',
                description: 'Request read access to user apps with Puter.js permissions API. Run and experiment with this example directly in the playground.',
                slug: 'perms-request-read-apps',
                source: '/playground/examples/perms-request-read-apps.html'
            },
            {
                title: 'Request Apps Manage Access',
                description: 'Request manage access to user apps with Puter.js permissions API. Run and modify this code example instantly in your browser.',
                slug: 'perms-request-manage-apps',
                source: '/playground/examples/perms-request-manage-apps.html'
            },
            {
                title: 'Request Subdomains Read Access',
                description: 'Request read access to user subdomains with Puter.js permissions API. Run and experiment with this example in the playground.',
                slug: 'perms-request-read-subdomains',
                source: '/playground/examples/perms-request-read-subdomains.html'
            },
            {
                title: 'Request Subdomains Manage Access',
                description: 'Request manage access to user subdomains with Puter.js permissions API. Run and modify this code example instantly in your browser.',
                slug: 'perms-request-manage-subdomains',
                source: '/playground/examples/perms-request-manage-subdomains.html'
            },
            {
                title: 'Request Desktop Access',
                description: 'Request access to Desktop folder with Puter.js permissions API. Run and experiment with this example in the playground.',
                slug: 'perms-request-desktop',
                source: '/playground/examples/perms-request-desktop.html'
            },
            {
                title: 'Request Documents Access',
                description: 'Request access to Documents folder with Puter.js permissions API. Run and modify this code example instantly in your browser.',
                slug: 'perms-request-documents',
                source: '/playground/examples/perms-request-documents.html'
            },
            {
                title: 'Request Apps Access',
                description: 'Request access to user apps with Puter.js permissions API. Run and experiment with this example directly in the playground.',
